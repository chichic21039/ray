...
class TestReplicaQueueLengthPolicy:
    @pytest.mark.parametrize("use_upscaling_factor", [True])
    def test_scaling_factor_scale_up_from_0_replicas(self, use_upscaling_factor):
    ...
    @pytest.mark.parametrize("use_downscaling_factor", [True])
    def test_scaling_factor_scale_down_to_0_replicas(self, use_downscaling_factor):
        """Test that a deployment scales down to 0 for non-default scaling factors."""

        # With downscaling_factor > 1, the desired number of replicas should
        ...
        # With downscaling_factor < 1, the desired number of replicas shouldn't
